...
<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v8.1" Namespace="DevExpress.Web.ASPxScheduler"
    TagPrefix="dxwschs" %>
<%@ Register Assembly="DevExpress.XtraScheduler.v8.1.Core, Version=8.1.6.0, Culture=neutral, PublicKeyToken=9b171c9fd64da1d1"
...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server" Width="694px" Height="25px">
